var AsyncLoop, ENV, Handler, async, compileTemplates, createHandler, frontend_queue, frontends, fs, handlers, http, jade, log, middleware_queue, middlewares, parseUrl, querystring, settings, templates, util;
