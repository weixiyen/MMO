UI.module('baseball.feed.index', function(){
    ...
    function loadChannel( channel ) {
        ...
        feed.loadChannel('baseball', channel);
    }
    ...
    -------------------------------------------------*/
    var request = {
        channels: ['feed:baseball:fantasy', 'news:baseball', 'feed:baseball:advice', 'feed:baseball:feedback', 'feed:baseball:offtopic', 'feed:baseball:commentary', 'cookies:baseball']
    };
